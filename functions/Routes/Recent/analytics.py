from yahoo_fin.stock_info import get_stats, get_stats_valuation
import json
import sys
...
val_keys = list(val_stats.keys())

for(key, value) in val_stats[val_keys[0]].items():
    val[value] = val_stats[val_keys[1]][key]
