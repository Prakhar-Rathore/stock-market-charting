      ...
      <Grid container sx={{
        ...
        <Grid item xs={12} md={7}>
          ...
          >
            ...
            <Typography component="h1" variant="h5" color="#e1b0f7" fontWeight={700}>
              WELCOME BACK TO
            </Typography>
            <Typography component="h1" variant="h5" color="#e1b0f7" fontWeight={700}>
            ...
            <Typography component="h4" variant="h5" color="#e1b0f7" fontWeight={500}>
              <br />
            ...
            <Box component="form" sx={{ mt: 3, color: "white", width: "100%" }}>
              <Grid container spacing={2} sx={{
                ...
                <Grid item xs={12} sx={{ display: "grid" }}>
                  <TextField
                    ...
                    InputProps={{
                      endAdornment: (
                        <InputAdornment position="end" style={{ ...(show && { display: "none" }), width: "40%" }}>
              ...
              <Grid container>
              <Grid item xs={show ? 4 : 0} display={!show ? "none" : "block"} textAlign="left">
                <Link to="/forgot-pass" style={{ color: "#5454d4" }}>
                  Forgot password?
                </Link>
              </Grid>

              <Grid item xs={show ? 8 : 12} style={{ textAlign:"end" , textAlignLast:"center" }}>
                Don't have an account?
                <Link to="/sign-up" variant="body2" style={{ marginLeft: "4px", color: "#5454d4" }}>
                  Create For Free
                </Link>
              </Grid>
